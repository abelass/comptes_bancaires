...
function comptes_bancaires_upgrade($nom_meta_base_version, $version_cible) {
	...
	$maj['create'] = array(array('maj_tables', array('banciare_comptes')));
...
function comptes_bancaires_vider_tables($nom_meta_base_version) {
	...
	sql_drop_table("banciare_comptes");

	# Nettoyer les versionnages et forums
	sql_delete("spip_versions",              sql_in("objet", array('banciare_compte')));
	sql_delete("spip_versions_fragments",    sql_in("objet", array('banciare_compte')));
	sql_delete("spip_forum",                 sql_in("objet", array('banciare_compte')));
