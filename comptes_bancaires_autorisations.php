 ...
 * @pipeline autoriser */
function comptes_bancaires_autoriser(){}


/* Exemple
function autoriser_comptes_bancaires_configurer_dist($faire, $type, $id, $qui, $opt) {
	// type est un objet (la plupart du temps) ou une chose.
	// autoriser('configurer', '_comptes_bancaires') => $type = 'comptes_bancaires'
	// au choix
...
/**
 * Autorisation de lier/délier l'élément (bancairecomptes)
 *
 * @param  string $faire Action demandée
 * @param  string $type  Type d'objet sur lequel appliquer l'action
 * @param  int    $id    Identifiant de l'objet
 ...
 * @return bool          true s'il a le droit, false sinon
**/
function autoriser_associerbancairecomptes_dist($faire, $type, $id, $qui, $opt) {
	return $qui['statut'] == '0minirezo' AND !$qui['restreint'];
}
